...
public class ServiceProviderSc {
    ...
    public void createNode(ZooKeeper zk,String url) throws KeeperException, InterruptedException {
        try {
            ...
            String path = zk.create("/company/sichuan/sichuan", data, ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.EPHEMERAL_SEQUENTIAL); // 创建一个临时性且有序的 ZNode
        } catch (Exception e)
        {
            System.out.print(e+"");
        }
